...
Game.prototype.getCss = function() {
  var bug = 'bug{position:fixed;z-index:99998;display:block;cursor:pointer;transition:transform 0.3s ease-in-out,opacity 0.3s ease-in-out;}';
  var button = 'no-more-bugs{';
  button += 'position:fixed;z-index:99999;display:block;cursor:pointer;padding:0.5em 1em;background:#444;color:white;bottom:0;right:0;';
