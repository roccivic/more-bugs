...
Bug.prototype.getSvg = function() {
  ...
  var quarterSize = size * .25;
  var halfSize = size / 2;
  var threeQuarterSize = size * .75;
  return '<svg xmlns="http://www.w3.org/2000/svg" width="' + size + '" height="' + size + '">' +
  '<g>' +
  '<rect style="fill:'+color+';" width="' + size + '" height="' + threeQuarterSize + '" x="0" y="' + quarterSize + '" ry="3" />' +
  '<rect style="fill:'+color+';" width="' + halfSize + '" height="' + halfSize + '" x="' + quarterSize + '" y="0" ry="3" />' +
  '</g>' +
  '</svg>';
};
